...
const Login = () => {
  ...
  const [formData, setFormData] = useState({
    email: 'demo@gmail.com', // Demo account email
    password: 'Demo@12345', // Demo account password
  });
  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-8 p-4">
        ...
        <div className="mb-4">
          <p className="text-gray-600 mb-2">Demo Account:</p>
          <p className="text-gray-800">
            Email: <span className="font-semibold">demo@gmail.com</span>
          </p>
          <p className="text-gray-800">
            Password: <span className="font-semibold">Demo@12345</span>
          </p>
        </div>
